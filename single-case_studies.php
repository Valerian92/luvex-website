<?php
/**
 * The template for displaying a single Case Study post.
 *
 * @package Luvex
 */
    ...
    <?php while ( have_posts() ) : the_post(); ?>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class('single-uv_news-container'); ?>>
            ...
            <footer class="single-news-footer">
                ...
                <!-- Post Navigation -->
                <nav class="post-navigation" aria-label="Case Study">
                    <h2 class="screen-reader-text">Case Study navigation</h2>
                    <div class="nav-links">
                        <?php
                        ...
                        ?>
                            <div class="nav-previous">
                                <a href="<?php echo get_permalink($prev_post->ID); ?>" rel="prev">
                                    <span class="nav-label"><i class="fa-solid fa-arrow-left"></i> Previous Case Study</span>
                        ...
                        ?>
                            <div class="nav-next">
                                <a href="<?php echo get_permalink($next_post->ID); ?>" rel="next">
                                    <span class="nav-label">Next Case Study <i class="fa-solid fa-arrow-right"></i></span>
