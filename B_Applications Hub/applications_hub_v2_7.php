...
<section class="section-container">
    <div class="content-wrapper">
        <div class="cta-section">
            <h3>Calculate Your UV Solution ROI</h3>
            <p>Every operation is unique. Use our ROI calculator to see potential cost savings and payback period for your specific application.</p>
            <div style="display: flex; gap: 1.5rem; justify-content: center; flex-wrap: wrap; margin-top: 2rem;">
                <a href="/roi-calculator" class="cta-button">
                    <i class="fas fa-calculator"></i>
                    ROI Calculator
                </a>
                <a href="/contact" class="cta-button" style="background: transparent; border: 2px solid var(--luvex-bright-cyan); color: var(--luvex-bright-cyan);">
