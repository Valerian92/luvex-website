...
function luvex_enqueue_assets() {
    wp_enqueue_style('luvex-style', get_stylesheet_uri(), array(), '2.0.1'); // Version erhöht
    ...
    // Alle Skripte verwenden jetzt get_stylesheet_directory_uri()
    wp_enqueue_script( 'luvex-footer-effect', get_stylesheet_directory_uri() . '/assets/js/footer-light-effect.js', array(), '1.0.0', true );
    wp_enqueue_script('luvex-mobile-menu', get_stylesheet_directory_uri() . '/assets/js/mobile-menu.js', array('jquery'), '1.0.1', true);
    wp_enqueue_script('three-js', 'https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js', array(), '128', true); // auf 'true' geändert für Footer-Ladung
    wp_enqueue_script('luvex-globe', get_stylesheet_directory_uri() . '/assets/js/globe-animation.js', array('three-js'), '1.0.1', true);
    wp_enqueue_script('luvex-modal', get_stylesheet_directory_uri() . '/assets/js/modal.js', array('jquery'), '1.0.1', true);
}
